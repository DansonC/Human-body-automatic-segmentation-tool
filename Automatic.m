...
% AUTOMATIC MATLAB code for Automatic.fig
...
%      applied to the GUI before Automatic_OpeningFcn gets called.  An
...
% Last Modified by GUIDE v2.5 05-Mar-2017 18:04:47
...
% --- Executes on button press in load_rgb.
function load_rgb_Callback(hObject, eventdata, handles)
% hObject    handle to load_rgb (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in load_depth.
function load_depth_Callback(hObject, eventdata, handles)
% hObject    handle to load_depth (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)


% --- Executes on button press in load_skeleton.
function load_skeleton_Callback(hObject, eventdata, handles)
% hObject    handle to load_skeleton (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
